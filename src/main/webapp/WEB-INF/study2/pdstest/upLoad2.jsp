  ...
  <title>upLoad2.jsp</title>
	...
	<script>
		...
		function fCheck() {
			...
			let fileSize1 = document.getElementById("file1").files[0].size; //자바스크립트 명령어
			if(uExt1 != "JPG" && uExt1 != "PNG" && uExt1 != "GIF" && uExt1 != "ZIP" && uExt1 != "HWP" &&  uExt1 != "PPTX" &&  uExt1 != "PPT" ) {
...
<div class="container">
  ...
  <form name="myform" method="post" action="${ctp}/upLoad2Ok.st" enctype="multipart/form-data"> <!-- 파일전송을 해야하면 반드시 enctype을 적어야함! -->
	  <div>
	  	파일명 : 
