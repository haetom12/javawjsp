...
insert into schedule values (default,'admin','2022-12-12','학습','딩코딩코');
...
insert into schedule values (default,'admin','2022-12-12','모임','가족조찬모임');
insert into schedule values (default,'admin','2022-12-02','기타','아무것도안함');
insert into schedule values (default,'haetom12','2022-12-25','학습','오전10시 스터디카페');
insert into schedule values (default,'haetom12','2022-12-31','여행','제주도출발');
insert into schedule values (default,'haetom12','2023-01-05','학습','코딩공부');
insert into schedule values (default,'r991454','2022-12-15','학습','프로젝트 회원관리완성');
insert into schedule values (default,'r991454','2022-12-25','모임','크리스마스 모임');
...
--select * from schedule where mid='haetom12' and date_format(sDate,'%Y-%m')='2023-1' group by part order by sDate desc; 날짜 에러 발생

select * from schedule where mid='haetom12' and date_format(sDate,'%Y-%m')='2023-01' group by part order by sDate desc;

select *,count(*) from schedule where mid='admin' and sDate='2022-12-08' group by part order by sDate desc;
