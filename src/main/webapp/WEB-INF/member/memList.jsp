  ...
  <form name="myform" method="post" action="${ctp}/memMemberSearch.mem">
  	<div class="row">
  		<div class="col form-inline">
  			<input type="text" name="mid" class="form-control autofocus" />&nbsp
  			<input type="button" value="아이디 개별검색" onclick="midSearch();" class="btn btn-primary" />
  		</div>
  		<div class="col text-right"><button type="button" class="btn btn-secondary"  onclick="location.href='${ctp}/memList.mem';">전체검색</button></div>
  	</div>
  </form>
