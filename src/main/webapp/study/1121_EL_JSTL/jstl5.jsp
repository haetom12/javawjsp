...
%>
	  ...
	  <p>
	    ...
	    <fmt:formatDate value="${now}" pattern="yyyy년 MM월 dd일 hh시mm분ss초"/> <br/>
	  </p>
	  <hr />
	  <h3>국가별설정(로케일)</h3>
	  <p>
	  ...
	  <p>절대경로 문 : 그림1 <img src="${ctp}/images/1.jpg" width="200px" />  </p>
	  <p>URL 문 : 그림2 <c:url var="img" value="${ctp}/images/1.jpg" />  </p>
	  							<img src="${img}" /> 
  </div>
</div>
<p><br/></p>
