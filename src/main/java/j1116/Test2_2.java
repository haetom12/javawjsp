...
public class Test2_2 extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		// 서버에서 get방식으로의 전송방법
		response.sendRedirect(request.getContextPath()+"/study/1116/test2Ok.jsp?hakbun="+hakbun+"&name="+name+"&kor="+kor+"&eng="+eng+"&mat="+mat+"&sci="+sci+"&tot="+tot+"&avg="+avg+"&grade="+grade);
