...
//		String com = uri.substring(uri.lastIndexOf("/"));
		...
		if(com.equals("/Test3_1") || com.equals("/test3_1") ) {
			...
			int res = t4.getCalc(su1,opt,su2);
